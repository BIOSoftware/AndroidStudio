...
/**
 * Created by Apisit on 29/08/2560.
 */
...
public class MonthYearPicker {
    ...
    private static final String[] PICKER_DISPLAY_MONTHS_NAMES = new String[] {"มกราคม", "กุมภาพันธ์", "มีนาคม", "เมษายน", "พฦษภาคม", "มิถุนายน", "กรกฎาคม", "สิงหาคม", "กันยายน",
            "ตุลาคม", "พฤษจิกายน", "ธันวาคม" };
    private static final String[] PICKER_DISPLAY_MONTHS_NAMES_ENG = new String[] { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct",
            "Nov", "Dec" };

    private static final String[] MONTHS = new String[] { "มกราคม", "กุมภาพันธ์", "มีนาคม", "เมษายน", "พฦษภาคม", "มิถุนายน", "กรกฎาคม", "สิงหาคม", "กันยายน",
            "ตุลาคม", "พฤษจิกายน", "ธันวาคม" };
    ...
    public void build(int selectedMonth, int selectedYear, DialogInterface.OnClickListener positiveButtonListener,
        ...
        yearNumberPicker.setMinValue(MIN_YEAR + 543);
        yearNumberPicker.setMaxValue(MAX_YEAR + 543);

        monthNumberPicker.setValue(selectedMonth);
        yearNumberPicker.setValue(selectedYear + 543);
